...
int main(int argc, char** argv)
{
    ...
    if (use_apriltag) {
        ...
        //for (size_t i = 0; i < imageFilenames.size()-1; ++i)
        //{
        //    image = cv::imread(imageFilenames.at(i), 0);

        //    Eigen::MatrixXd OutPutPoints;
        //    vector<bool> outCornerObserved;
        ...
        //    {
        //        if(outCornerObserved[j])
        //        {
        //            corners.push_back(cv::Point2f(OutPutPoints.row(j)[0],OutPutPoints.row(j)[1]));
        //            tagpoints.push_back(cv::Point3f(aprilgrid.point(j)[0],aprilgrid.point(j)[1],0.0));
        //        }
        //    }
        //    if(corners.size()>=16)
        //    {
        //        calibration.addApriltagDate(corners,tagpoints);
        //        apriltagFound.at(i) = true;
        //    }
